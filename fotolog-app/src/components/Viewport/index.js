...
export class Viewport extends React.Component {
    list = [
        {src: 'http://placekitten.com/400/400', createdBy: 'FUlano', comments: [{ name: 'Anonimo', comment: 'Foda' }, { name: 'Anonimo', comment: 'Foda' }, { name: 'Anonimo', comment: 'Foda' }, { name: 'Anonimo', comment: 'Foda' }, { name: 'Anonimo', comment: 'Foda' }, { name: 'Anonimo', comment: 'Foda' }] },
    ...
    render() {
        return (
            <ViewportComponent>
                {this.list.map((v, k) => <Picture key={k} user={v.createdBy} src={v.src} comments={v.comments} />)}
            </ViewportComponent>
        )
    }
}